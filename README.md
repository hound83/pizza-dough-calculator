...
[![Tests](https://img.shields.io/badge/regression_tests-86%2F86_passing-76c990)](tests/test_v50.js)
...
> Tag **v1.0.0** remains the immutable golden behavior baseline. v1.1.1 is the current public release; this branch builds the backward-compatible v1.3.0 anonymous-feedback candidate on the accepted v1.2.0 staged calculation model without changing storage schema 51.
...
| **v1.3.0** | Optional anonymous-feedback functionality on top of v1.2.0 |
...
- **Release:** v1.1.1 is current; v1.2.0 is the accepted staged-calculation candidate and v1.3.0 is the feedback candidate built on it. Tag v1.0.0 remains the immutable historical golden baseline.
...
- **v1.3.0 candidate:** account-free in-app feedback with explicit public-storage notice, opt-in safe diagnostics, server-side anti-bot validation, and no calculator-state migration.
