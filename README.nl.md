...
[![Tests](https://img.shields.io/badge/regressietests-90%2F90_groen-76c990)](tests/test_v50.js)
...
> Tag **v1.0.0** blijft de onveranderlijke golden gedragsbaseline. v1.2.1 is de huidige publieke release; deze branch bouwt de achterwaarts compatibele v1.3.0-feedbackkandidaat bovenop die complete release zonder opslagschema 51 te wijzigen.
...
De structuurtest controleert daarnaast de twaalf vaste modulegrenzen, scriptvolgorde, unieke HTML-id's, inline-handlercontracten, één eigenaar voor opslag/bootstrap, bundle-actualiteit, exacte reconstructie van de huidige featurebundle, alle uitgebrachte baselines tot en met v1.2.1 en de geïntegreerde v1.3.0-kandidaat. Playwright opent beide publicaties op 320, 390, 430, 760, 1024 en 1280 px en controleert foutloos laden en horizontale passing. Gerichte tests bewaken het gefaseerde wateradvies, de v1.2.1-vertaling en sauskeuze, en de succes-, niet-geconfigureerd-, privacy-, payload- en retryroutes van het feedbackvenster. De telefoontests beschermen de schermvullende picker en het klik-versus-hover-contract. De Workersuite injecteert Turnstile- en GitHub-responses en bewijst dat secrets en receptdata niet over de API-grens kunnen gaan.
...
| **v1.3.0** | Optionele anonieme feedbackfunctionaliteit bovenop v1.2.1 |
...
- **Release:** v1.2.1 is de huidige release; v1.3.0 is de geïntegreerde feedbackkandidaat. Tag v1.0.0 blijft de onveranderlijke historische golden baseline.
...
- **Audit:** v1.2.0, v1.2.1 en de feedbackkandidaat zijn vóór integratie onafhankelijk door Claude gecrosscheckt.
...
- **v1.2.0:** een op warmtecapaciteit gebaseerd gefaseerd DDT-model met aparte routes en normale-keukenbegeleiding.
- **v1.2.1:** herstelde NL/EN-teksten, correcte Marinara-lagen en een schonere ingeklapte sausoverride met behoud van alle zeven saustypes.
- **v1.3.0-kandidaat:** accountvrije feedback met duidelijke openbare opslagmelding, optionele veilige diagnostiek, server-side anti-botvalidatie en geen migratie van calculatorstate.
