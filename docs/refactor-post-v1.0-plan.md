...
tests/browser/refactor.spec.js     18 Chromium browser and layout tests
...
4. Add reproducible Chromium coverage for both publications and six responsive viewport widths, with focused mobile picker assertions.
...
1. Ask Claude to compare the completed refactor directly with `main`.
2. Resolve any loading, hosting, browser, or maintainability findings on this branch.
3. Keep product version 1.0.0 while behavior remains fully equivalent.
4. Consider ES modules, removal of inline handlers, and a DOM-independent calculation core only in separately audited architecture work.
5. Build Basic/Full as new **v1.1.0** functionality after the refactor is accepted.
