# Claude audit handoff — v1.2.0 anonymous feedback candidate

## Audit target

- Base release commit: `f85c1d2ce274a9c68e04916d55f630ce4d5c6fef` (`main`, released v1.1.1)
- Candidate branch: `feature/v1.2.0-feedback`
- Comparison: <https://github.com/hound83/pizza-dough-calculator/compare/main...feature/v1.2.0-feedback>
- Public version in the candidate: `1.2.0`
- Persistence remains: `pizzaCalcV51` / schema `51`

This is a feature audit, not a behavior-neutral refactor audit. The intended new behavior is a Dutch/English in-app feedback form that does not require a GitHub account. All pizza, dough, fermentation, mixer, picker, Basic/Full, AVPN, and persistence behavior must remain unchanged from v1.1.1.
...
| Artefact | SHA-256 |
|---|---|
| standalone `index.html` | `7221e269540af944510c924f21d634a6febccdc411ee6a3c804abb1f21134d5f` |
| CSS | `dae8b7731125c3540d3070b0940290052cc93d1d86db17d398643b215b5c5f7e` |
| combined JavaScript | `d3e9e735bc73f9b6829f2bc88a946b06ee5f2b171a1692180df2d2e6769caec1` |
...
76/76 standalone functional regressions
76/76 modular-source functional regressions
```

Playwright discovers 37 Chromium checks: the existing 31 plus six feedback cases across standalone and source. The new browser coverage verifies a 320 px English success flow with an exact opt-in payload, the localized unconfigured path, and draft preservation after a backend failure for both publications.

This Codex sandbox has no Chromium executable, so local launch stops before application code runs. GitHub Actions must run all 37 checks with its installed Chromium before this candidate can advance.
...
8. Is this a coherent backward-compatible v1.2.0 feature candidate, subject only to the explicitly deferred production configuration and real end-to-end check?
