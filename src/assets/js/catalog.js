...
const pizzaRecipes=[
  ...
  {id:'marinara',name:'Marinara',tag:'Traditioneel',sauce:'marinara',sauceG:80,
   items:[],
   note:'Zonder kaas. Knoflook, oregano en EVOO zitten al in de Marinara-saus.',
   noteEn:'No cheese. The garlic, oregano and EVOO are already included in the Marinara sauce.'},
